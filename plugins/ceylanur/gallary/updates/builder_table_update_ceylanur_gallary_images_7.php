...
class BuilderTableUpdateCeylanurGallaryImages7 extends Migration
{
    public function up()
    {
        Schema::table('ceylanur_gallary_images', function($table)
        {
            $table->string('style', 10)->nullable()->unsigned(false)->default(null)->comment(null)->change();
    ...
    public function down()
    {
        Schema::table('ceylanur_gallary_images', function($table)
        {
            $table->integer('style')->nullable()->unsigned(false)->default(null)->comment(null)->change();
